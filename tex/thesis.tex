%\documentclass[goeng, submitted, additionalreferee]{thesis}
\documentclass[goeng, print, file, additionalreferee]{thesis}


\makeatletter
\newif\iffile
\@ifclasswith{thesis}{file}{\filetrue}{\filefalse}
\makeatother


\title{Inverse Problems in Asteroseismology}
...
\refereec{\textbf{Prof.~Dr.~Yvonne Elsworth, FRS}}
\instrefereec{\emph{School of Physics and Astronomy, University of Birmingham, United Kingdom}}
...
%\laurenttrue
\laurentfalse
%\newcommand{\lr}[1]{{{\iflaurent\textcolor{red}{#1}}\else{#1}\fi}}
%\newcommand{\lr}[1]{\iffalse\else{#1}\fi}
%\newcommand{\lr}[1]{{#1}}
\newcommand{\lr}[1]{\iflaurent\color{red} #1 \color{black}\else #1\fi }
...
\hyphenation{Pul-sa-tions-fre-quen-zen}
\hyphenation{astero-seis-mol-o-gy}
\hyphenation{helio-seis-mol-o-gy}
...
%\thispagestyle{plain}
\thispagestyle{empty}
%\iffile\vspace*{4cm}\else\vspace*{7cm}\fi
\vspace*{7cm}
%\vspace*{3.8cm}
%\begin{center}
...
\input{chN1_publications.tex}

\chapter*{Acknowledgements\markboth{Acknowledgements}{Acknowledgements}}
\addcontentsline{toc}{chapter}{Acknowledgements}
\input{chN2_acknowledgements} 
